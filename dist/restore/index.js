...
Object.defineProperty(exports, "__esModule", { value: true });
exports.writeToFile = exports.toBase64Url = void 0;
const fs = __importStar(__webpack_require__(747));
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.get = exports.Response = exports.Type = void 0;
...
class Response {
    constructor(accessKeyId, secretAccessKey, sessionToken, s3ObjectPath, cacheHit) {
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const authResponse = yield auth.get(key, auth.Type.Download);
