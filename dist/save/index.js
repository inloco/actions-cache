...
exports.generateTemporaryFile = generateTemporaryFile;
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            if (core.getState('cache-hit') === 'true') {
                ...
                yield utils.writeToFile(tmp, files.join('\n'));
                core.info('Saving cache...');
                yield proc.shell(`tar -c -T ${tmp} | aws s3 cp - $S3_PATH`);
                yield io.rmRF(tmp);
            }
        }
        catch (error) {
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.exec = exports.shell = void 0;
